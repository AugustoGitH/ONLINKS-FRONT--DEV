...
export default function ProfileInput({ maxSizeInBytes, src, onChange = () => { }, reset = false }: ProfileInputProps) {
  ...
  return (
    <S.ProfileInput>
      ...
      <input accept="image/*" type="file" onChange={handleChangeInputFile} id="input-profile" />
